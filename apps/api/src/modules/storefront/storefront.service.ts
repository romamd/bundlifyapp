...
export class StorefrontService {
  ...
  async getThemeSettings(shopDomain: string) {
    ...
    return {
      ...
      giftBgColor: s?.widgetGiftBgColor ?? '#fef9c3',
      giftTextColor: s?.widgetGiftTextColor ?? '#854d0e',
      giftSelectedBgColor: s?.widgetGiftSelectedBgColor ?? '#fef08a',
      giftSelectedTextColor: s?.widgetGiftSelectedTextColor ?? '#713f12',
      upsellBgColor: s?.widgetUpsellBgColor ?? '#f0fdf4',
      upsellTextColor: s?.widgetUpsellTextColor ?? '#166534',
      upsellSelectedBgColor: s?.widgetUpsellSelectedBgColor ?? '#dcfce7',
      upsellSelectedTextColor: s?.widgetUpsellSelectedTextColor ?? '#14532d',
      labelFontSize: s?.widgetLabelFontSize ?? 11,
      labelFontWeight: s?.widgetLabelFontWeight ?? 'bold',
      giftFontSize: s?.widgetGiftFontSize ?? 13,
      giftFontWeight: s?.widgetGiftFontWeight ?? 'normal',
      upsellFontSize: s?.widgetUpsellFontSize ?? 13,
      upsellFontWeight: s?.widgetUpsellFontWeight ?? 'normal',
      unitLabelFontSize: s?.widgetUnitLabelFontSize ?? 13,
      unitLabelFontWeight: s?.widgetUnitLabelFontWeight ?? 'bold',
      spacing: s?.widgetSpacing ?? 12,
      ...
      stickyBarButtonText: s?.stickyBarButtonText ?? 'Choose Bundle',
      stickyBarTitleFontSize: s?.stickyBarTitleFontSize ?? 14,
      stickyBarTitleFontWeight: s?.stickyBarTitleFontWeight ?? 'normal',
      stickyBarButtonFontSize: s?.stickyBarButtonFontSize ?? 14,
      stickyBarButtonFontWeight: s?.stickyBarButtonFontWeight ?? 'bold',
      stickyBarButtonPadding: s?.stickyBarButtonPadding ?? 15,
      stickyBarButtonBorderRadius: s?.stickyBarButtonBorderRadius ?? 8,
